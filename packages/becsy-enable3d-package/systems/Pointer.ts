...
// import {Mouse, MouseSystem, Target} from 'becsy-package';
...
//
//     private readonly pointer = this.query(q => q.usingAll.current.read.with(Pointer, CameraComponent).added.removed.write);
//     private ball: any;
//
//     rayCaster = new Raycaster();
//
//     factory = this.singleton.read(SceneComponent);
//
//     mouse = this.singleton.read(Mouse)
//
//     execute() {
//         return
//         const factory = this.factory.scene as MainScene;
//         if (!factory) {
//             return
//         }
