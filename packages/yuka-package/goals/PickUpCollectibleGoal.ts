...
export class PickUpCollectibleGoal extends Goal<any> {
    ...
    constructor(owner: { data: { deltaTime: number; currentTime: number; pickUpDuration: number; }; }) {
    ...
    override activate(): void {
        ...
        for (const steering of this.owner.steering.behaviors) {
            ...
            if (steering.target) {
                steering.target = this.targetPosition
            }
        }
    ...
    override execute(): void {
        ...
        // this.owner.steering.behaviors.forEach(e => e.active = false)
        ...
        if (owner.data.currentTime >= owner.data.pickUpDuration) {
            ...
            owner.sendMessage(targetGameEntity, (sender, receiver) => {
