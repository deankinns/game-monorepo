import {GameEntity, GoalEvaluator, MathUtils, Think} from 'yuka';
 ...
 */
class GetHealthEvaluator extends GoalEvaluator<GoalSubject> {
     ...
     */
    constructor(characterBias = 1, itemType: any) {
    ...
    setGoal(owner: Vehicle & {brain: Think<any & GameEntity>}) {
        ...
        const brain = owner.brain//owner.entity.read('BrainComponent').object
