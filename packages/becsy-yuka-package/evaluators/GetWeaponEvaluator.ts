...
// import {componentRegistry, Vehicle} from "../../yuka-package/entities";
...
class GetWeaponEvaluator extends GoalEvaluator<any> {
   ...
   */
  constructor(characterBias = 1, itemType: any = null) {
    super(characterBias);
  ...
  setGoal(owner: Vehicle) {
    const brain = owner.components.read(BrainComponent).object;
